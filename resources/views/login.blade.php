...
<html>
    ...
    <body>
        <div class = "flex h-screen w-screen p-10">
            <div class = "rounded-2xl bg-gray-300 h-full w-1/3 p-5 ml-55">
            ...
            <div class = "h-full w-1/3 p-5 text-center">
                ...
                <br>
                <button class = "font-mono border-0 font-semibold outline-gray-300 outline-4 p-2 w-60 rounded-3xl text-xl text-gray-400 hover:bg-gray-300 hover:text-gray-700 hover:outline-gray-300 hover:border-gray-300 transition delay-40 furation-300"> Registrar-se </button>
            </div>
        </div>
    </body>
</html>
