        ...
        <div class = "h-full w-full p-5 grid place-items-center text-center">
            ...
            <div class = "text-left w-full">
                <form method = "POST" action = "/postsubmit">
                    ...
                    <br>
                    <br>
                    <input type= "text" placeholder = "Titulo" name = "title" value = "{{old('title')}}" class= "font-mono font-medium rounded-2xl border-gray-300 border-3 border-solid p-2 w-50 focus:border-gray-400 focus:outline-0 transition delay-40 duration-300 w-full">
                    <br>
                    <div class = "h-2">
                        @error('title')
                    ...
                    <br>
                    <br>
                    <textarea name = "text" value = "{{old('text')}}" class= "font-mono font-medium rounded-2xl border-gray-300 border-3 border-solid p-2 w-50 focus:border-gray-400 focus:outline-0 transition delay-40 duration-300 h-70 w-full"> </textarea>
                    <br>
                    <div class = "h-2">
                        @error('text')
                            <p class = "text-red-400"> {{$message}} </p>
